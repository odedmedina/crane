...
global r x y l vr angle theta dtheta theta_dot  time_step hook_r hook_y z crane_h omega
...
theta=theta(2);x=x(2);y=y(2);r=r(2);l=l(2);angle=angle(2);dtheta=dtheta(2);
z=crane_h-l;
