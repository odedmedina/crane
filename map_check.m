...
try
    ...
    if map(x,y+max_ptp)<z-2 && map(x,y)<z-2 && map(x,y-max_ptp)<z-2
        if  map(x-max_ptp,y+max_ptp)<z-2 && map(x-max_ptp,y)<z-2 && map(x-max_ptp,y-max_ptp)<z-2 %%%%%%% z
            if  map(x+max_ptp,y+max_ptp)<z-2 && ~map(x+max_ptp,y)<z-2 && map(x+max_ptp,y-max_ptp)<z-2
